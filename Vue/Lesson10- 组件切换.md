...
````vue
    <button @click="changeOpacity">点我动态显示</button>
    <transition name='wave'>
      <div v-show="opacityS" :class="show">
        <h1>我要动态显示</h1>
      </div>
    </transition>
````
...
![mark](http://qiniu.cloud-zhi.com/blog/210424/5iAJLALCBJ.png?imageslim)
...
````vue
    ...
    <transition name="wave" v-show="opacityS" mode="out-in">
